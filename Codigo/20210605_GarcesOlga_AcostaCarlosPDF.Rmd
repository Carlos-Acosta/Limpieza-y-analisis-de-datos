...
Visualizamos la importancia de las varialbes para el árbol podado que acabamos de crear. **La variable de mayor importancia es el sexo de los pasajeros**, seguida de la clase, número de personas que viajaban con un billete.  
` `  
```{r}
varImp(prunedrpart)
```
...
Por último, palicamos una validación cruzada de 5 folds para el Random Forest. 
...
` `    
**OLGA:quieres que quitemos el código de estas tablas?**  
...
**OLGA** **a qué te refieres con lo siguiente?**
...
**Código** 
` `     
El código empleado en la realización de este proyecto se ha mantenido visible para su potencial estudio y uso si fuera el caso.` `  
