...
Este subconjunto se utilizará practicamente en la totalidad de los análisis por ser la variable dependiente y principal a la pregunta realizada.<p>
...
Este subconjunto nos ayudará a poder tener diferenciados los datos por la variable Sexo (hombres y mujeres) y poder realizar contrastes de hipótesis, regresiones logísticas, árboles de decisión y un modelo Random Forest.<p>
...
Este subconjunto nos ayudará a poder tener diferenciados los datos por la variable Age (menores y adultos) y poder realizar contrastes de hipótesis, regresiones logísticas, árboles de decisión y un modelo Random Forest.<p>
...
Este subconjunto nos ayudará a poder tener diferenciados los datos por la variable Count.ticket (únicos o grupales) y poder realizar contrastes de hipótesis (incluyendo un Xi cuadrado), regresiones logísticas, árboles de decisión y un modelo Random Forest.<p>
...
**OLGA en el anterior creas una columna, aquí necesitamos partir los datos en dos grupos de personas solas o acompañadas.**
...
**OLGA: he hecho cambios, he comentado todo según los resultados, he cambiado un poco la formulación de las hipótesis. Tu código lo he dejado comentado, por si acaso**
...
<br>
De igual forma, al ser valor p=1 mayor que alfa, si rechazamos la hipótesis nula, posiblemente estaremos comentiendo un error.
...
**OLGA** el OR menor que 1 es factor de protección. Quiere decir que ser hombre reduce la probabilidad de sobrevivir en comparación con ser mujer. Cambio la formulación.. pero así se llama, factor de protección
...
**Olga: puede que sí, puede que no, si la variable que he incorporado no ayuda a predecir más**
...
**CARLOS: UNA VEZ CORRAMOS POR ULTIMA VEZ EL CODIGO, PODEMOS ACTUALIZAR EL TEXTO DE LA TABLA Y PONER LOS RESULTADOS GRÄFICOS DEL ARBOL CON MEJOR PRECISION Y EL DEL RANDOM FOREST**
...
SibSp|Survived|2.2e-16|Las varianzas en SibSp dde los pasajeros en función de la supervivencia son diferentes
...
-------- | --------------| ----- | ----- | -----------------------------------
Sex(hombres/mujeres)|Survived|Proporción Supervivencia|XXXXX|XXXXXX
Age(menores/adultos)|Survived|Proporción Supervivencia|XXXXX|XXXXXX
Tipo Billete (único/conjunto)|Survived|Proporción Supervivencia|XXXXX|XXXXXX
...
* Las personas que viajaban con uno o más acompañantes también sobrevivieron en mayor proporción.<p>



En definitiva, **el juego de datos nos ayuda a responder el problema/pregunta principal planteada en cuanto a los factores influyentes en la supervivencia del accidente del Titanic**<p>

Los análisis mostrados reflejan qué y cómo pudieron influir los diferentes factores en la supervivencia de los viajeros.<p>
...
El código empleado en la realización de este proyecto se ha mantenido visible para su potencial estudio y uso si fuera el caso.<p>
...
https://github.com/Carlos-Acosta/Limpieza-y-analisis-de-datos<p>
