...
# Alternativa más corta en código
sapply(df, summary)
```
```{r }
...
OLGA: esto lo he hecho más arriba con df$Education <- factor(df$Education, levels = c(10, 11, 12, 13, 14, 15, 16, 17, 18)) para asegurar que se respetan los niveles
```{r echo=TRUE, message=FALSE, warning=FALSE}
