...
model2=glm(formula=trainy~Pclass+Sex+Age+factor(Count.ticket)+Embarked,
...
probabilities2 <- model2 %>% predict(newdata[c("Pclass", "Sex", "Age", "Count.ticket", 
                                               "Embarked")], type = "response")
